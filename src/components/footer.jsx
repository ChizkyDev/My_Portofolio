  ...
  return (
    <footer className="bg-dark pt-24 pb-12">
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-[50%_15%_16%_15%] gap-8 ">
          <div className="text-slate-300 font-medium">
            <h1 className="mb-[24px] font-semibold text-xl text-white">
              Chizky
            ...
            <p>
              Chizky Developer hadir sebagai identitas kreatif saya di dunia web
              development. Saya berfokus pada desain estetik dan pengalaman
              pengguna yang nyaman, dengan perhatian pada detail dan hasil yang
          ...
          <div>
            <h3 className="font-semibold text-xl text-white mb-5">Skills</h3>
            <ul className="text-slate-300">
              <li>
                <a
                  href="#"
          ...
          <div>
            ...
            <ul className="text-slate-300 space-y-3">
              <li>
                <a
                  href="#beranda"
                  className="inline-block text-base hover:text-blue-600"
                >
                  Home
                </a>
              </li>
